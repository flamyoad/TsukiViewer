...
public final class DatabaseModule_ProvideCollectionDaoFactory implements Factory<CollectionDao> {
  ...
  public CollectionDao get() {
    return provideCollectionDao(module, databaseProvider.get());
  }

  public static DatabaseModule_ProvideCollectionDaoFactory create(DatabaseModule module,
      Provider<AppDatabase> databaseProvider) {
    return new DatabaseModule_ProvideCollectionDaoFactory(module, databaseProvider);
  }

  public static CollectionDao provideCollectionDao(DatabaseModule instance, AppDatabase database) {
    return Preconditions.checkNotNullFromProvides(instance.provideCollectionDao(database));
  }
}
