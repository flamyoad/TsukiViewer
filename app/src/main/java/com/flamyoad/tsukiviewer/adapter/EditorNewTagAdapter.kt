...
import com.flamyoad.tsukiviewer.ui.editor.CreateTagListener
import com.flamyoad.tsukiviewer.ui.search.TagSelectedListener
import java.util.*

class EditorNewTagAdapter(private val listener: CreateTagListener):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        if (viewType == ITEM) {
            ...
            layout.setOnClickListener {
                ...
                listener.onTagCreated(tag.name, tag.type)
            }
            return holder
